...
export default async function ContactPage() {
  ...
  const channels = [
    ...
    { icon: Phone, label: "Phone", value: site.phone, href: site.telHref },
    { icon: MapPin, label: "Studio", value: site.address, href: null },
  ];
  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-28">
      ...
      <div className="mt-16 flex flex-col justify-between gap-8 border-t border-line pt-10 sm:flex-row sm:items-end">
        ...
        <Link
          href="/#book"
          className="inline-flex w-fit items-center gap-1 rounded-sm bg-text px-6 py-3.5 sm:ml-auto text-base font-semibold text-white transition-colors hover:bg-text/90"
        >
          Request a Quote →
        </Link>
      </div>
